    ...
    tabPanel("Fit Model for Tumor Growth Data",
             sidebarLayout(
               sidebarPanel(
                 ...
                 textInput("drug_a", "Drug A Group Name:", value = "Drug_A"),
                 textInput("drug_b", "Drug B Group Name:", value = "Drug_B"),
                 textInput("drug_c", "Drug C Group Name (if present):", value = ""),
                 textInput("combination", "Combination Group Name (Drug A + Drug B (+ Drug C, if present)):", value = "Combination"),
